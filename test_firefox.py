...
def test_schedule_success(browser_firefox, name, lastname):
    ...
    browser_firefox.find_element(By.NAME, "phone").send_keys("+7-951-289-75-12")
    browser_firefox.find_element(By.NAME, "email").send_keys("eudvlad@gmail.com")
